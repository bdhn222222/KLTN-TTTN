  ...
  Prescription_payment.init(
    {
      ...
      payment_method: {
        ...
        allowNull: true,
        comment:
          "Phương thức thanh toán: cash - tiền mặt, zalopay - thanh toán qua ZaloPay, null - chưa chọn phương thức",
      },
      status: {
        ...
        comment:
          "Trạng thái thanh toán: pending - chờ thanh toán, paid - đã thanh toán, cancelled - đã hủy",
      },
      payment_date: {
        type: DataTypes.DATE,
        allowNull: true,
