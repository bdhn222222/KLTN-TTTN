...
const AppointmentPaymentPage = () => {
    ...
    try {
      ...
      if (initialPrescriptionStatus) {
        ...
        console.log(
          ...
          appointmentData.prescription.status
        );
      }
      ...
      if (initialAppointmentStatus) {
        ...
        if (!appointmentData.appointment_info) {
          appointmentData.appointment_info = {
        ...
        console.log(
          ...
          appointmentData.appointment_info.status
        );
      }

      console.log(
        "Final appointment data with updated statuses:",
        appointmentData
      );
      ...
      const hasPayment = !!(
        appointmentData.payment || appointmentData.Payments
      );
      ...
      showNotification("error", "Error", "Unable to load appointment details");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handlePaymentProcess = async () => {
    try {
      ...
      if (appointmentDetail.payment) {
        payment_id =
          appointmentDetail.payment.id || appointmentDetail.payment.payment_id;
      ...
      if (!payment_id) {
        ...
        try {
          ...
          if (
            completeError.response?.data?.message?.includes("đã hoàn thành") ||
            ...
            try {
              ...
              if (refreshedData.payment) {
                payment_id =
                  refreshedData.payment.id || refreshedData.payment.payment_id;
                ...
                console.log(
                  "Found payment_id in Payments after refresh:",
                  payment_id
                );
              }
            } catch (refreshError) {
          ...
          if (!payment_id) {
            throw new Error(
              "Không thể tìm thấy hoặc tạo mới thông tin thanh toán"
            );
          }
        }
      }
  ...
  const calculatePrescriptionTotal = () => {
    ...
    return appointmentDetail.prescription.medicines.reduce(
  ...
  return (
    <Layout style={{ minHeight: "100vh" }}>
                ...
                <Card className="shadow-sm mb-4">
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <Tag
                      color={
                        getStatusColor(
                          appointmentDetail.payment?.status || "pending"
                        ).color
                      }
                    >
                      {
                    ...
                    {appointmentDetail.payment?.status === "paid" && (
                      <>
                        ...
                        <Descriptions.Item label="Payment Date">
                          {dayjs(appointmentDetail.payment.payment_date).format(
                            "DD/MM/YYYY HH:mm"
                          )}
                        </Descriptions.Item>
                      </>
                    ...
                    <div>
                      ...
                      <p>
                        ...
                        <Tag
                          color={
                            getStatusColor(
                              appointmentDetail.appointment_info?.status ||
                                "pending"
                            ).color
                          }
                          className="ml-2"
                  ...
                  <Card title="Medical Record" className="shadow-sm mb-4">
                    <Descriptions column={1} bordered>
                      ...
                      <Descriptions.Item label="Created At">
                        {dayjs(
                          appointmentDetail.medical_record.createdAt
                        ).format("DD/MM/YYYY HH:mm")}
                      </Descriptions.Item>
                    </Descriptions>
                  </Card>
                ...
                {appointmentDetail.prescription && (
                  ...
                  >
                    <div className="mb-4">
                      ...
                      <table className="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                          {appointmentDetail.prescription.medicines.map(
                            (medicine) => (
                              <tr key={medicine.id}>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap">
                                  {medicine.total.toLocaleString("vi-VN")} VNĐ
                                </td>
                              </tr>
                            )
                          )}
                          <tr className="bg-gray-50">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap font-semibold">
                              {totalPrescriptionAmount.toLocaleString("vi-VN")}{" "}
                              VNĐ
                            </td>
                          </tr>
                        </tbody>
                    ...
                    <Descriptions column={1}>
                      <Descriptions.Item label="Created At">
                        {dayjs(appointmentDetail.prescription.createdAt).format(
                          "DD/MM/YYYY HH:mm"
                        )}
                      </Descriptions.Item>
                    </Descriptions>
      ...
      >
        <p>
          Have you successfully received the cash payment of{" "}
          <strong>{totalAmount?.toLocaleString("vi-VN")} VNĐ</strong>?
        </p>
      </Modal>
    </Layout>
